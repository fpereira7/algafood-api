...
create table grupo_permissao (grupo_id bigint not null, grupo_permissao_id bigint not null) engine=InnoDB
...
create table usuario_grupo (usuario_id bigint not null, usuario_grupo_id bigint not null) engine=InnoDB
alter table cidade add constraint FKkworrwk40xj58kevvh3evi500 foreign key (estado_id) references estado (id)
alter table grupo_permissao add constraint FKtdiacjjhflmwxdey6b57qx4ci foreign key (grupo_permissao_id) references permissao (id)
...
alter table usuario_grupo add constraint FKrp8adt5151f30p7kowbtxl5ri foreign key (usuario_grupo_id) references grupo (id)
