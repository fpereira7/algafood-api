...
// controlador de excecao global para os handlesS
@ControllerAdvice
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		...
		String detail = "O corpo da requisição está inválido. Verifique o erro da sintaxe";
	...
	//capturando outras possiveis excecoes na chamada da api
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		...
		ProblemType problemType = ProblemType.RECURSO_NAO_ENTRCONTRADO;
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s' "
				+ "que é um tipo inválido. Corrija e informe o valor compatível com o tipo %s.", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName());
